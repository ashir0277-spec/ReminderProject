...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const inactiveClass =
    'text-[#898989] hover:bg-[#1E2730] hover:text-white transition-colors duration-200';
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 z-50 h-screen w-[280px] bg-[#13191D] text-white
      ...
      >
        ...
        <div className="flex items-center px-6 py-8 border-b border-gray-700">
          ...
          <div className="ml-4">
            <p className="text-[#888FBB] font-bold text-xl">CEO</p>
        ...
        <nav className="flex-1 px-3 py-6 space-y-2 overflow-y-auto">
          ...
          >
            ...
            <span className="ml-5 text-sm font-medium">Calendar</span>
          </NavLink>
          ...
          <div className="bg-white rounded-xl shadow-lg w-80 p-6">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-indigo-950 text-white hover:bg-indigo-950"
              >
                Logout
              </button>
            </div>
